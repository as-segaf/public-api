<?php 
  ...
  $channelUrl = 'https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyAaowNY4z7-F1lWXgI0QOQYucg_YthCLcU';
  $result = get_url($channelUrl);
  ...
  // latest video
  $latestVideoUrl = 'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&key=AIzaSyAaowNY4z7-F1lWXgI0QOQYucg_YthCLcU&order=date&channelId=UCkXmLjEr95LVtGuIm3l2dPg';
  $result = get_url($latestVideoUrl);
